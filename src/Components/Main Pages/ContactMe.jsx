...
export default function ContactMe(){
    ...
    return(
        <Box className={styles.fullBox} style={{backgroundColor: '#1b1b1b', color:'white', paddingBottom: '50px'}} overflow='auto'>
        <Grid className={[styles.fullBox, styles.center]} direction='column' container>
            ...
            <Typography variant='h5'>Where I Live: Tempe AZ</Typography>
        </Grid>
        </Box>
    )
}